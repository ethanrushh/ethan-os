...
{
    // Puts us in to a 320x200 resolution graphic mode. Technically 256 colors but we can only use 16 with teletype.
    // The entire buffer can fit into a single 64KB segment
    SetVideoMode();
